...
class Person:
    ...
    def findDeltaVal(self):
        ...
        for a in self.neighbors:
            self.deltaVal += (self.peopleList[a].val - self.val) / len(self.peopleList) / 1000
...
for a in range(34):
    if a == 0:
        ...
        valInit = math.exp(10 * nx.resistance_distance(G, 0, a)) / (math.exp(10 * nx.resistance_distance(G, 0, a)) + math.exp(10 * nx.resistance_distance(G, 33, a)))
...
#    runIteration()
colors = list(map(lambda c: c.val, peopleList))
